...
g01.addButton('U', "res/button/up.bmp", width // 2 - 35, 20, g02.id)
g01.addButton('L', "res/button/left.bmp", 20, height // 2 - 35, g03.id)
g01.addButton('R', "res/button/right.bmp", width - 100, height // 2 - 35, g04.id)
g02.addButton('D', "res/button/down.bmp", width // 2 - 35, height - 100, g01.id)
g03.addButton('R', "res/button/right.bmp", width - 100, height // 2 - 35, g01.id)
g04.addButton('L', "res/button/left.bmp", 20, height // 2 - 35, g01.id)
